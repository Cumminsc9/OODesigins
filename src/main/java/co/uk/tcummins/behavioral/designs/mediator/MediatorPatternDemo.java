...
//    Implementation
//    We are demonstrating mediator pattern by example of a chat room where multiple users can send message to
//    chat room and it is the responsibility of chat room to show the messages to all users. We have created two
